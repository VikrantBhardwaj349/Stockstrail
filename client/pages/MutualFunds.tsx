  ...
  return (
    <Layout>
      <SEO
        ...
        description="Learn about mutual funds, how they work, and why they're ideal for wealth creation. Get professional fund management, diversification, and low entry barriers with Stockstrail."
        keywords="mutual funds, SIP, wealth creation, investment, equity funds, debt funds, hybrid funds"
      ...
      <section className="relative px-4 sm:px-6 lg:px-8 pt-24 pb-16">
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-white/80 max-w-3xl mx-auto leading-relaxed text-lg">
            Grow your wealth steadily with expert-managed portfolios. Start investing with as little as ₹100 through SIPs and benefit from professional fund management.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-white/80 leading-relaxed mb-4">
                A mutual fund is an investment vehicle that collects money from multiple investors and invests it in a diversified portfolio such as stocks, bonds, government securities, and other financial instruments.
              </p>
              <p className="text-white/80 leading-relaxed mb-4">
                These funds are managed by professional fund managers who make investment decisions on behalf of investors. Mutual funds allow individuals to begin investing with small amounts while benefiting from diversification and expert management.
              </p>
              <p className="text-white/80 leading-relaxed">
                Instead of tracking markets daily or picking individual stocks, you can simply invest and let professionals handle the portfolio management.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-stockstrail-bg-light/40 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-stockstrail-green-light/30 hover:shadow-[0_0_24px_rgba(0,255,151,0.12)] transition-all duration-300 group">
              <h3 className="text-xl font-semibold text-stockstrail-green-light mb-3 group-hover:text-white transition-colors">Low Entry Barrier</h3>
              <p className="text-white/80">Investors can start with small contributions through SIPs. Many funds allow investments starting from as low as ₹100.</p>
            </div>

            {/* Card 2 */}
            <div className="bg-stockstrail-bg-light/40 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-stockstrail-green-light/30 hover:shadow-[0_0_24px_rgba(0,255,151,0.12)] transition-all duration-300 group">
              <h3 className="text-xl font-semibold text-stockstrail-green-light mb-3 group-hover:text-white transition-colors">Professional Management</h3>
              <p className="text-white/80">Qualified fund managers analyse markets, financial data, and company performance to make informed investment decisions.</p>
            </div>

            {/* Card 3 */}
            <div className="bg-stockstrail-bg-light/40 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-stockstrail-green-light/30 hover:shadow-[0_0_24px_rgba(0,255,151,0.12)] transition-all duration-300 group">
              <h3 className="text-xl font-semibold text-stockstrail-green-light mb-3 group-hover:text-white transition-colors">Diversification</h3>
              <p className="text-white/80">A single mutual fund invests across various companies and sectors, helping reduce risk compared to individual stocks.</p>
            </div>

            {/* Card 4 */}
            <div className="bg-stockstrail-bg-light/40 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-stockstrail-green-light/30 hover:shadow-[0_0_24px_rgba(0,255,151,0.12)] transition-all duration-300 group">
              <h3 className="text-xl font-semibold text-stockstrail-green-light mb-3 group-hover:text-white transition-colors">Higher Returns Potential</h3>
              <p className="text-white/80">Over the long term, mutual funds—especially equity-oriented funds—have historically delivered higher returns compared to savings accounts.</p>
            </div>

            {/* Card 5 */}
            <div className="bg-stockstrail-bg-light/40 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-stockstrail-green-light/30 hover:shadow-[0_0_24px_rgba(0,255,151,0.12)] transition-all duration-300 group">
              <h3 className="text-xl font-semibold text-stockstrail-green-light mb-3 group-hover:text-white transition-colors">Liquidity</h3>
              <p className="text-white/80">Investors can redeem their mutual fund units easily, except in schemes with lock-in periods such as ELSS.</p>
            </div>

            {/* Card 6 */}
            <div className="bg-stockstrail-bg-light/40 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-stockstrail-green-light/30 hover:shadow-[0_0_24px_rgba(0,255,151,0.12)] transition-all duration-300 group">
              <h3 className="text-xl font-semibold text-stockstrail-green-light mb-3 group-hover:text-white transition-colors">Passive Investing</h3>
              <p className="text-white/80">No need to monitor markets daily or make frequent trading decisions. Let professionals handle it for you.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-stockstrail-bg-light/30 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-stockstrail-green-light/30 transition-all duration-300">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-white/70">Long-term investors, individuals looking to grow wealth, and those comfortable with market fluctuations.</p>
                </div>
                <div>
            ...
            <div className="bg-stockstrail-bg-light/30 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-stockstrail-green-light/30 transition-all duration-300">
              ...
              <p className="text-white/80 mb-4">
                Debt funds invest in fixed-income instruments such as government bonds, corporate bonds, certificates of deposit, and other debt securities.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <p className="text-white font-semibold mb-2">Suitable for:</p>
            ...
            <div className="bg-stockstrail-bg-light/30 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-stockstrail-green-light/30 transition-all duration-300">
              ...
              <p className="text-white/80 mb-4">
                Hybrid funds invest in a mix of equity and debt instruments. The combination provides both growth potential and stability.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <p className="text-white font-semibold mb-2">Suitable for:</p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-stockstrail-bg-light/30 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-stockstrail-green-light/30 hover:shadow-[0_0_24px_rgba(0,255,151,0.12)] transition-all duration-300">
              <h3 className="text-2xl font-semibold text-stockstrail-green-light mb-4">SIP (Systematic Investment Plan)</h3>
              ...
              <div className="mt-6 p-4 bg-stockstrail-green-light/10 border border-stockstrail-green-light/20 rounded-lg">
                <p className="text-sm text-white/80">
                  <strong className="text-white">Example:</strong> A monthly SIP of ₹2,000 for 15 years may potentially grow into ₹10–12 lakh depending on the fund's performance.
                </p>
              </div>
            </div>
            ...
            <div className="bg-stockstrail-bg-light/30 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-stockstrail-green-light/30 hover:shadow-[0_0_24px_rgba(0,255,151,0.12)] transition-all duration-300">
              ...
              <div className="mt-6 p-4 bg-stockstrail-green-light/10 border border-stockstrail-green-light/20 rounded-lg">
                <p className="text-sm text-white/80">
                  <strong className="text-white">Flexibility:</strong> You can combine both SIP and lump sum to optimize your investment strategy.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            <div className="bg-stockstrail-bg-light/50 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-stockstrail-green-light/30 transition-all duration-300">
              ...
              <p className="text-white/80">Investing ₹1,000 per month for 10 years may grow to approximately ₹2–2.5 lakh depending on market conditions.</p>
            </div>

            <div className="bg-stockstrail-bg-light/50 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-stockstrail-green-light/30 transition-all duration-300">
              <p className="text-stockstrail-green-light font-semibold mb-2">Example 2:</p>
              <p className="text-white/80">Investing ₹5,000 per month for 20 years may create a corpus of ₹50–60 lakh, assuming consistent market performance.</p>
            </div>

            <div className="bg-stockstrail-bg-light/50 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-stockstrail-green-light/30 transition-all duration-300">
              <p className="text-stockstrail-green-light font-semibold mb-2">Example 3:</p>
              <p className="text-white/80">Investing ₹1,00,000 in a debt fund for one year may yield around ₹6,000–8,000 in returns, depending on interest rate conditions.</p>
            </div>

            <div className="bg-stockstrail-bg-light/50 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-stockstrail-green-light/30 transition-all duration-300">
              <p className="text-white font-semibold mb-2 text-sm">⚠️ Disclaimer:</p>
              <p className="text-white/70 text-sm">These are illustrative examples only. Actual returns may vary based on market performance, fund selection, and investment period. Past performance is not indicative of future results.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-stockstrail-green-light/10 border-l-4 border-stockstrail-green-light rounded-lg p-6">
            <p className="text-white/90">
              <strong className="text-stockstrail-green-light">How to Manage Risk:</strong> These risks can be managed through long-term investing, diversification across different fund types, and selecting well-performing funds aligned with your risk profile.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { title: "Expert Selection", desc: "Assistance in choosing from 100+ mutual fund schemes across all categories." },
