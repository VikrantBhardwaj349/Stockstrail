        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16 mb-16">
          ...
          <FooterSection title="Holidays Calendar">
            <div className="space-y-4">
              ...
              <a href="/nse-holidays" className="block text-white hover:text-stockstrail-green-light hover:translate-x-2 transition-all duration-300 group cursor-pointer">
              ...
              <a href="/bse-holidays" className="block text-white hover:text-stockstrail-green-light hover:translate-x-2 transition-all duration-300 group cursor-pointer">
                <div className="flex items-center justify-between gap-4 p-3 rounded-md hover:bg-white/5 transition-colors duration-200">
                  <div>
                    <div className="text-white font-montserrat text-base group-hover:text-stockstrail-green-light">
